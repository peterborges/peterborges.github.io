...
// ============ LIGHT / DARK THEME ============
// Flip the dot/background colors with the site theme: light dots on a dark stage
// in dark mode, dark dots on a light stage in light mode. The CRT vignette/scanlines
// only read well over a dark stage, so they're dialed out in light mode.
function applyTheme() {
  const light = document.documentElement.getAttribute('data-theme') === 'light';
  const u = dotMatrixPass.uniforms;
  if (light) {
